package com.suyh0201.sys.constant;
...
public final class ErrorCodeConstants {
    ...
    public static final int NON_DEBUG_NODE = 999999;

    // 系统
    // 不支持的操作与功能
    public static final int SYSTEM_UNSUPPORTED = 1010001;

    // 某条记录不存在
    public static final int BASE_RECORD_NOT_EXISTS = 1011001;
    // 某条记录已存在
    public static final int BASE_RECORD_DUPLICATE = 1011002;
    ...
    public static final int NON_ADMIN_ROLE = 1014404;
    ...
    public static final int BANK_NUM_EXISTS = 1015014;
    // 某条记录不存在
    ...
    public static final int UTR_DUPLICATE_IN_ORDER = 1015025;
    public static final int DUPLICATE_ABNORMAL_ORDER = 1015026;
    public static final int TPP_CARD_NO_EXISTS = 1015027;
    public static final int AVAILABLE_BANK_DUPLICATED = 1015028;
    public static final int AVAILABLE_TPP_DUPLICATED = 1015029;
    public static final int TPP_ENABLE_EXISTS = 1015030;
    public static final int TPP_CODE_TPP_TPPCARDNO_EXISTS = 1015031;

    public static final int WEIGHT_CONFIG_ID_NOT_EXISTS = 1016001;

    public static final int FILE_NOT_EXISTS = 1017001;
    public static final int IMAGE_DOWNLOAD_FAILED = 1017002;
    public static final int IMAGE_DOWNLOAD_EMPTY = 1017003;
    public static final int OCR_IMAGE_PARSE_FAILED = 1017004;


    public static final int VIP_REMITTANCE_ID_NOT_EXISTS = 1018001;
    public static final int VIP_REMITTANCE_EMPTY = 1018002;
    public static final int VIP_REMITTANCE_ADDRESS_CANNOT_EMPTY = 1018003;
    public static final int VIP_REMITTANCE_CODE_DUPLICATED = 1018004;
    public static final int VIP_REMITTANCE_ADDRESS_DUPLICATED = 1018005;
    public static final int VIP_REMITTANCE_IMPORT_EMPTY = 1018006;
    public static final int VIP_REMITTANCE_IMPORT_CODE_DUPLICATED = 1018007;
    public static final int VIP_REMITTANCE_IMPORT_ADDR_DUPLICATED = 1018008;
    public static final int VIP_REMITTANCE_ADDRESS_DISABLE = 1018009;
    public static final int VIP_REMITTANCE_ADDRESS_USED = 1018010;
    public static final int VIP_REMITTANCE_ADDRESS_TOQR_FAILED = 1018011;


    public static final int SVIP_REMITTANCE_ACCOUNT_ID_NOT_EXISTS = 1019001;

    public static final int SVIP_TPP_TEST_RECORD_UTR_EXISTS = 1020001;

    public static final int SVIP_CODE_REFUND_RECORD_UTR_EXISTS = 1021001;
    public static final int SVIP_CODE_REFUND_RECORD_UTR_NOT_EXISTS = 1021002;
    public static final int SVIP_CODE_REFUND_IMG_RECORD_UTR_NOT_EXISTS = 1021003;
    public static final int SVIP_CODE_REFUND_STATUS_MISMATCH = 1021004;
    public static final int SVIP_CODE_REFUND_RECORD_REFUND_NO_EXISTS = 1021005;

    public static final int TPP_STD_CONFIG_ITEM_CANNOT_EMPTY = 1022001;
    public static final int TPP_STD_CONFIG_ITEM_BOUND_VALUE_DUPLICATE = 1022002;
    public static final int TPP_STD_CONFIG_ITEM_LOST_INFINITY = 1022003;

    public static final int SVIP_BANK_CONFIG_BANK_CODE_EXISTS = 1023001;
    public static final int SVIP_BANK_CONFIG_NOT_EXISTS = 1023002;
    public static final int SVIP_BANK_CONFIG_BANK_CODE_DISABLE = 1023003;

    public static final int SVIP_BANK_MAINTENANCE_NOT_EXISTS = 1024001;

    public static final int SVIP_EDIT_PHONE_NUMBER_EXISTS = 1024002;
}
